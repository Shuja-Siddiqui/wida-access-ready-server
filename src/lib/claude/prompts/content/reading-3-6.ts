...
Passage must make the skill demonstrable in print. Match text_format and passage_word_max.
Narrate → sequence/story. Inform → facts/main ideas. Explain → how/why in the text. Argue → position + stated evidence.
If has_library_image: the passage is about that photo; questions still from the text.
Questions: exactly question_count, ONLY types in OUTPUT SCHEMA. Include every schema key. Foils = plausible misreadings of THIS passage. Multiple choice: exactly 3 options (1 correct + 2 distractors).
